...
//Name: towerCannon3D.ma
//Last modified: Fri, Jun 06, 2014 06:29:14 PM
//Codeset: 1252
requires maya "2014";
...
createNode mesh -n "polySurfaceShape64" -p "polySurface64";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "transform61" -p "polySurface51";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape51" -p "transform61";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
connectAttr "groupId72.id" "groupParts54.gi";
...
connectAttr "groupId74.id" "groupParts56.gi";
connectAttr "polySeparate5.out[3]" "groupParts57.ig";
connectAttr "groupId75.id" "groupParts57.gi";
connectAttr "polySeparate5.out[4]" "groupParts58.ig";
connectAttr "groupId76.id" "groupParts58.gi";
connectAttr "polySeparate5.out[5]" "groupParts59.ig";
connectAttr "groupId77.id" "groupParts59.gi";
connectAttr "polySeparate5.out[6]" "groupParts60.ig";
connectAttr "groupId78.id" "groupParts60.gi";
connectAttr "polySeparate5.out[7]" "groupParts61.ig";
connectAttr "groupId79.id" "groupParts61.gi";
connectAttr "polySeparate5.out[8]" "groupParts62.ig";
connectAttr "groupId80.id" "groupParts62.gi";
connectAttr "polySeparate5.out[9]" "groupParts63.ig";
connectAttr "groupId81.id" "groupParts63.gi";
connectAttr "polySeparate5.out[10]" "groupParts64.ig";
connectAttr "groupId82.id" "groupParts64.gi";
connectAttr "polySeparate5.out[11]" "groupParts65.ig";
connectAttr "groupId83.id" "groupParts65.gi";
connectAttr "polySeparate5.out[12]" "groupParts66.ig";
